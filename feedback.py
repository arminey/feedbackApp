...
class Feedback:
	...
	def __init__(self, master):
		...
		ttk.Label(self.frame_header, text = "Text for Exploring", style = 'Header.TLabel').grid(row = 0, column = 1)
	...
	def submit(self):
		...
		self.clear()
		messagebox.showinfo(title = "Explore Calofornia Feedback", message = "Comments Submitted!")
